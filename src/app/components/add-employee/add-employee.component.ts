...
export class AddEmployeeComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (this.activatedRoute.snapshot.params['id'] != undefined) {
      this.dataService.currentEmployee.subscribe((employee: { name?: any; profilePic?: any; gender?: any; salary?: any; startDate?: any; note?: any; department?: any; }) => {
        if (Object.keys(employee).length !== 0) {
          ...
          employee.department.forEach((departmentElement: any) => {
  ...
  */
  ...
  onSubmit() {
    if (this.employeeFormGroup.invalid) {
      ...
      if (this.activatedRoute.snapshot.params['id'] != undefined) {
        this.httpService.updateEmployeData(this.activatedRoute.snapshot.params['id'], this.employee).subscribe((response: any) => {
